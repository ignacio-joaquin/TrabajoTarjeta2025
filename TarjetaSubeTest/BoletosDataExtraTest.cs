...
{
    [TestFixture]
    public class BoletosDataExtraTest
    {
        [SetUp]
        public void Setup()
        {
        ...
        [Test]
        public void TestBoletoTarjetaNormal2()
        {
            DateTime fechaFija = new DateTime(2024, 1, 15, 14, 30, 0);
            DateTimeProvider.SetDateTimeProvider(() => fechaFija);
        ...
        [Test]
        public void TestBoletoFranquiciaCompleta2()
        {
            DateTime fechaFija = new DateTime(2024, 1, 15, 14, 30, 0);
            DateTimeProvider.SetDateTimeProvider(() => fechaFija);
        ...
        [Test]
        public void TestBoletoMedioBoletoEstudiantil2()
        {
            DateTime fechaFija = new DateTime(2024, 1, 15, 14, 30, 0);
            DateTimeProvider.SetDateTimeProvider(() => fechaFija);
        ...
        [Test]
        public void TestBoletoGratuitoEstudiantil2()
        {
            DateTime fechaFija = new DateTime(2024, 1, 15, 14, 30, 0);
            DateTimeProvider.SetDateTimeProvider(() => fechaFija);
        ...
        [Test]
        public void TestBoletoConSaldoNegativoYRecargo2()
        {
            DateTime fechaFija = new DateTime(2024, 1, 15, 14, 30, 0);
            DateTimeProvider.SetDateTimeProvider(() => fechaFija);
        ...
        [Test]
        public void TestBoletoConSaldoNegativoPrevio2()
        {
            DateTime fechaFija = new DateTime(2024, 1, 15, 14, 30, 0);
            DateTimeProvider.SetDateTimeProvider(() => fechaFija);
        ...
        [Test]
        public void TestBoletoConConstructorFechaEspecifica2()
        {
            DateTime fechaEspecifica = new DateTime(2024, 1, 15, 14, 30, 0);
            Boleto boleto = new Boleto(1580, "142", 3420, "Normal", "TEST004", 
                                     1580, fechaEspecifica); // Agregar el parámetro descuentoFrecuente (0)
        ...
        [Test]
        public void TestBoletoManipulacionFechas2()
        {
            ...
            Boleto boleto1 = new Boleto(1580, "K", 5000, "Normal", "TEST005", 
                                      1580, fechaBase); // Agregar el parámetro descuentoFrecuente (0)
            ...
            Boleto boleto2 = new Boleto(1580, "142", 5000, "Normal", "TEST006", 
                                      1580, fechaConDias); // Agregar el parámetro descuentoFrecuente (0)
            ...
            Boleto boleto3 = new Boleto(1580, "144", 5000, "Normal", "TEST007", 
                                      1580, fechaConHoras); // Agregar el parámetro descuentoFrecuente (0)
            Assert.AreEqual(fechaBase.AddHours(2.5), boleto3.Fecha);
        }

        [Test]
        public void TestTodosLosTiposTarjetaEnBoletos2()
        {
            DateTime fechaFija = new DateTime(2024, 1, 15, 14, 30, 0);
            DateTimeProvider.SetDateTimeProvider(() => fechaFija);
